...
class Explorer{
	 ...
	 * @return bool
	 */
	public function Create($is_dir=false, $create_if_exists=false, $chmod="0700"){
	...
	public function Copy($destination){
		...
		if(is_dir($this->_path)){
			...
			/* MODIFIED */
			if (empty($result)) {
				$result = array('1'=>array('type'=>'dir', 'fullpath'=>$this->_path));
			}
	 ...
	 * @return array
	 */
	public function Listing($exclude_extension=array('php','html','bash_history','pearrc','htaccess','txt','DS_Store'), $exclude_file=array(".DS_Store"), $exclude_dir=array("recycle_bin", 'thumbnail'), $recursive=false, &$list=array(), $dir=""){
